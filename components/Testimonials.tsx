            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mt-8 gap-4">
              <div className="flex items-center gap-3">
                <img 
                  ...
                  alt="Alex MacCaw" 
                  className="w-12 h-12 rounded-full bg-zinc-800 border border-white/5"
                  onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=Alex+MacCaw&background=random'; }}
                />
                <div>
              ...
              <div className="bg-[#0A0A0A] p-8 rounded-3xl border border-white/10 hover:border-white/20 transition-colors flex flex-col justify-between h-auto">
                 ...
                 <div className="flex items-center gap-3 mt-8">
                    <img 
                      ...
                      alt="Christian" 
                      className="w-10 h-10 rounded-full bg-zinc-800 border border-white/5"
                      onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=Christian&background=random'; }}
                    />
                    <div>
              ...
              <div className="bg-[#0A0A0A] p-8 rounded-3xl border border-white/10 hover:border-white/20 transition-colors">
                 ...
                 <div className="flex items-center gap-3 mt-8">
                    <img 
                      ...
                      alt="Alex Volkov" 
                      className="w-10 h-10 rounded-full bg-zinc-800 border border-white/5"
                      onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=Alex+Volkov&background=random'; }}
                    />
                    <div>
              ...
              <div className="bg-[#0A0A0A] p-8 rounded-3xl border border-white/10 hover:border-white/20 transition-colors">
                 ...
                 <div className="flex items-center gap-3 mt-8">
                    <img 
                      ...
                      alt="Francesco" 
                      className="w-10 h-10 rounded-full bg-zinc-800 border border-white/5"
                      onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=Francesco&background=random'; }}
                    />
                    <div>
              ...
              <div className="bg-[#0A0A0A] p-8 rounded-3xl border border-white/10 hover:border-white/20 transition-colors">
                 ...
                 <div className="flex items-center gap-3 mt-8">
                    <img 
                      ...
                      alt="Dr. Palmer Piana" 
                      className="w-10 h-10 rounded-full bg-zinc-800 border border-white/5"
                       onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=Dr+Palmer&background=random'; }}
                    />
                    <div>
              ...
              <div className="bg-[#0A0A0A] rounded-3xl border border-white/10 hover:border-white/20 transition-colors overflow-hidden group cursor-pointer">
                 ...
                 <div className="p-5 flex items-center gap-3">
                    <img 
                      ...
                      className="w-10 h-10 rounded-full bg-zinc-800 border border-white/5"
                      onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=Fernando+Anselmi&background=random'; }}
                    />
                    <div>
