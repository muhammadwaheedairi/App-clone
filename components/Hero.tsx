  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden bg-[#050505] px-4 pt-10 pb-20">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <a href="#" className="mt-10 inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[#111] border border-white/10 text-[13px] text-zinc-500 hover:text-white hover:border-white/20 transition-all group backdrop-blur-sm">
